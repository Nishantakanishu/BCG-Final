  ...
  return (
    <div className=" py-5 md:flex lg:max-w-5xl md:gap-5 mx-auto md:items-center border border-gray-300 shadow-lg px-2">
      ...
      <div className="desc space-y-4 p-6 md:p-3">
        ...
        <button className="px-8 py-3 md:py-2 bg-primary text-white rounded-full shodow-lg cursor-pointer " onClick={() => handleToogleForm(name)}>Request a Quote______</button>
      </div>
    </div>
  )
}
